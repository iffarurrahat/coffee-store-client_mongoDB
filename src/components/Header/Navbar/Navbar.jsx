...
//         { id: 3, path: user ? '/signout' : '/signin', name: user ? 'Sign Out' : 'Sign In' },
//     ];
...
//                         }
//                     </div>
//                     <ul className={`md:flex gap-16 absolute md:static bg-primary md:bg-transparent mr-4 md:mr-0 right-0 px-6 md:px-0 py-4 rounded-lg font-rancho text-xl ${open ? 'top-16' : '-top-60'}`}>
//                         {
//                             routes.map(route => (
//                                 <li key={route.id}>
